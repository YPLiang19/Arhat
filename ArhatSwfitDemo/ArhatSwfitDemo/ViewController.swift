...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc
    dynamic
    func varArgsAndStringFormatExample() {
      self.resultView.text = "replace varArgsAndStringFormatExample faild"
    }
